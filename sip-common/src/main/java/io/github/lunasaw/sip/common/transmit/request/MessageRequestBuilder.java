 ...
 * @author luna
 */
public class MessageRequestBuilder extends AbstractSipRequestBuilder {
     ...
     * @return MESSAGE请求
     */
    public Request buildMessageRequest(FromDevice fromDevice, ToDevice toDevice, String content, String callId) {
