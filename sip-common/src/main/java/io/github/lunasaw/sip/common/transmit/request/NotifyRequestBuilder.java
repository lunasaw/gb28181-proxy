 ...
 * @author luna
 */
public class NotifyRequestBuilder extends AbstractSipRequestBuilder {
     ...
     * @return NOTIFY请求
     */
    public Request buildNotifyRequest(FromDevice fromDevice, ToDevice toDevice, String content, SubscribeInfo subscribeInfo, String callId) {
