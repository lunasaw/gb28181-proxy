package io.github.lunasaw.sipproxy.common.conf;
...
public class DefaultProperties {
    ...
    public static Properties getProperties(String name, boolean sipLog) {
         ...
         */
        if (sipLog) {
            properties.setProperty("gov.nist.javax.sip.STACK_LOGGER", "io.github.lunasaw.gbproxy.common.conf.StackLoggerImpl");
            properties.setProperty("gov.nist.javax.sip.SERVER_LOGGER", "io.github.lunasaw.gbproxy.common.conf.ServerLoggerImpl");
