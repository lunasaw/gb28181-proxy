...
public class Gb28181TestClient {
    ...
    public void before() {
        ...
        toDevice = ToDevice.getInstance("41010500002000000001", "10.37.2.198", 8116);
        toDevice.setPassword("bajiuwulian1006");

        DefaultRegisterProcessorClient.deviceMap.put("41010500002000000001", toDevice);
